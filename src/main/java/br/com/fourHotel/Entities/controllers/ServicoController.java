...
public class ServicoController {
	...
	@GetMapping(path = "/produtosf")
	public String produtosf(Model model) {
	...
	@GetMapping(path = "/compraf/{idServico}")
	public String comprarf(@PathVariable int idServico, Model model) {
		...
		pedido.setTipo(servico.getTipo());
		pedido.setValor(servico.getValor());
		pedido.setLogin(funcionario.getLogin());
		pedido.setQuarto(quarto);
